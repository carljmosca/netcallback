...
public final class CallbackProtocol {
    ...
    /**
     * Request passed from the private to the public server followed by the
     * version number and the redirect port number.
     */
    ...
    /**
     * Request the termination of the tunnel followed by one argument specifying
     * the port to be terminated
     */
